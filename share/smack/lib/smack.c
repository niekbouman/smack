...
void __SMACK_decls(void) {
  ...
  D("function $extractvalue.bv16.bv8(p: bv16, i: int) returns (bv8);\n");
  D("function $extractvalue.i16.i8(p: i16, i: int) returns (i8);\n");
  D("function $extractvalue.bv32.bv16(p: bv32, i: int) returns (bv16);\n");
  D("function $extractvalue.i32.i16(p: i32, i: int) returns (i16);\n");
  D("function $extractvalue.bv48.bv24(p: bv48, i: int) returns (bv24);\n");
  D("function $extractvalue.i48.i24(p: i48, i: int) returns (i24);\n");
  D("function $extractvalue.bv64.bv32(p: bv64, i: int) returns (bv32);\n");
  D("function $extractvalue.i64.i32(p: i64, i: int) returns (i32);\n");
  D("function $extractvalue.bv80.bv40(p: bv80, i: int) returns (bv40);\n");
  D("function $extractvalue.bv96.bv48(p: bv96, i: int) returns (bv48);\n");
  D("function $extractvalue.i96.i48(p: i96, i: int) returns (i48);\n");
  D("function $extractvalue.bv112.bv56(p: bv112, i: int) returns (bv56);\n");
  D("function $extractvalue.bv128.bv64(p: bv128, i: int) returns (bv64);\n");
  D("function $extractvalue.i128.i64(p: i128, i: int) returns (i64);\n");
  D("function $extractvalue.ref.bv1(p: ref, i: int) returns (bv1);\n");
  D("function $extractvalue.ref.i1(p: ref, i: int) returns (i1);\n");
  D("function $extractvalue.ref.bv8(p: ref, i: int) returns (bv8);\n");
  D("function $extractvalue.ref.i8(p: ref, i: int) returns (i8);\n");
  D("function $extractvalue.ref.bv16(p: ref, i: int) returns (bv16);\n");
  D("function $extractvalue.ref.i16(p: ref, i: int) returns (i16);\n");
  D("function $extractvalue.ref.bv24(p: ref, i: int) returns (bv24);\n");
  D("function $extractvalue.ref.i24(p: ref, i: int) returns (i24);\n");
  D("function $extractvalue.ref.bv32(p: ref, i: int) returns (bv32);\n");
  D("function $extractvalue.ref.i32(p: ref, i: int) returns (i32);\n");
  D("function $extractvalue.ref.bv40(p: ref, i: int) returns (bv40);\n");
  D("function $extractvalue.ref.i40(p: ref, i: int) returns (i40);\n");
  D("function $extractvalue.ref.bv48(p: ref, i: int) returns (bv48);\n");
  D("function $extractvalue.ref.i48(p: ref, i: int) returns (i48);\n");
  D("function $extractvalue.ref.bv56(p: ref, i: int) returns (bv56);\n");
  D("function $extractvalue.ref.i56(p: ref, i: int) returns (i56);\n");
  D("function $extractvalue.ref.bv64(p: ref, i: int) returns (bv64);\n");
  D("function $extractvalue.ref.i64(p: ref, i: int) returns (i64);\n");
  D("function $extractvalue.ref.bv72(p: ref, i: int) returns (bv72);\n");
  D("function $extractvalue.ref.bv80(p: ref, i: int) returns (bv80);\n");
  D("function $extractvalue.ref.bv88(p: ref, i: int) returns (bv88);\n");
  D("function $extractvalue.ref.i88(p: ref, i: int) returns (i88);\n");
  D("function $extractvalue.ref.bv96(p: ref, i: int) returns (bv96);\n");
  D("function $extractvalue.ref.i96(p: ref, i: int) returns (i96);\n");
  D("function $extractvalue.ref.bv104(p: ref, i: int) returns (bv104);\n");
  D("function $extractvalue.ref.bv112(p: ref, i: int) returns (bv112);\n");
  D("function $extractvalue.ref.bv120(p: ref, i: int) returns (bv120);\n");
  D("function $extractvalue.ref.bv128(p: ref, i: int) returns (bv128);\n");
  D("function $extractvalue.ref.i128(p: ref, i: int) returns (i128);\n");
  D("function $extractvalue.ref.ref(p:ref, i: int) returns (ref);\n");
